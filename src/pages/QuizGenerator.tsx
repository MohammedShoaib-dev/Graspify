...
/**
 * Mock quiz questions
 * In production, these would be generated by AI from source material
 */
const mockQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: "e",
    explanation:
      "This is one of the definitions of Euler's number e ≈ 2.71828.",
    difficulty: "hard",
  },
  {
    id: "5",
 ...
 *
 * Provides a complete quiz experience:
...
export default function QuizGenerator() {
  ...
  const { addXP, incrementStat, updateMissionProgress, unlockBadge } =
    useGameStore();
  ...
  /**
   * Generate a new quiz from source material
   * Uses Gemini AI to generate realistic quiz questions
   */
  const generateQuiz = async () => {
    if (!sourceText.trim()) {
      toast({
        title: "Please enter source material",
        description: "Paste or type some study material to generate a quiz.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      // Create new quiz with AI-generated questions
      const newQuiz: Quiz = {
        id: `quiz-${Date.now()}`,
      ...
      toast({
        ...
        description: "Failed to generate quiz. Please check your input and try again.",
        variant: "destructive",
      });
    } finally {
        ...
        <Card className="max-w-2xl mx-auto">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              You answered {answers.filter((a) => a.correct).length} out of{" "}
